...
void create_windowmain()
{
	...
	//menuitemrule4 = gtk_radio_menu_item_new_with_label(gtk_radio_menu_item_get_group(GTK_RADIO_MENU_ITEM(menuitemrule1)), language==0?"Professional renju":(language==1?_T("RIF规则"):""));
